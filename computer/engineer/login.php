...
$stmt=$mysqli->prepare("SELECT username,email,password,id FROM enggineerregistration WHERE (userName=?|| email=?) and password=? ");
...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/bg11.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-4x">Engineer Login</h1>
