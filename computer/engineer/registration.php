...
$password=$_POST['password'];
	$result ="SELECT count(*) FROM enggineerregistration WHERE email=?";
...
$query="insert into  enggineerregistration(username,Name,contactNo,email,password) values(?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssiss',$username,$Name,$contactNo,$emailid,$password);
$stmt->execute();
...
<body>
	...
	<div class="login-fullpage bk-img" style="background-image: url(img/bg11.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-4x">Engineer Registration </h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-9 col-md-offset-2"> 
								...
								<form action="" class="mt" method="post">
									...
									<input type="text" placeholder="Contact Number" name="contactNo" id="contactNo"  class="form-control mb"
									pattern="^\d{10}$" title="Enter 10 digits only" required>

									<label for="" class="text-uppercase text-sm">Email-id</label>
									<input type="text" placeholder="Email-id" name="email"  id="email"  class="form-control mb" onBlur="checkAvailability()" required="required">
									...
									<input type="password" placeholder="Password" name="cpassword" id="cpassword" class="form-control mb">
