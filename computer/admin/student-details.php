		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print"> 
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:3%">Customer Details</h2>
...
$aid=$_SESSION['login'];
   $ret="select * from customers where (email=?)";
...
<tr>
<td colspan="5" style="text-align:center; color:blue"><h3>Customer Realted Info</h3></td>
</tr>
